 ...
 * @version 1.0
 */
public class SMS_Code implements Authentification_Method
{
     ...
     */
    public boolean isCorrectNumber(String num)
    {
        if(num.contains("+"))
            return true;
        else
    ...
    public void getInformation()
    {
        ...
        do
        {
            ...
            if(!isCorrectNumber(phone_Number))
        ...
        } while(!isCorrectNumber(phone_Number));
    ...
    public void verifyInformation()
    {
        if(isCorrectNumber(phone_Number))
        {
            ...
            System.out.print(Color_Printer.BOLD + "\nA code has been sent to " + Color_Printer.BLUE + phone_Number + "\n" + Color_Printer.RESET

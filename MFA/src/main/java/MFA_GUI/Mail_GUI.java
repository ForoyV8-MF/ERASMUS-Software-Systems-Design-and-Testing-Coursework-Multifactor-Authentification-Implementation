...
/**
 * The GUI Interface for Mail Code Verification.
 */
public class Mail_GUI extends Method_GUI
{
    /**
     * Write the Title
     */
    ...
    {
        JLabel labelTitle = new JLabel("Mail Code");
        ...
        if(!informationTextField.getText().isEmpty())
        {
            try
            {
                ...
                if(Main.chosenMethod.isCorrectInformation(Main.chosenMethod.getParameter()))
                {
                    ...
                    resultLabelInformation.setText("Correct Mail");
                ...
                else
                {
                    ...
                    resultLabelInformation.setText("Incorrect Mail");
    ...
    {
        JLabel labelInformation = new JLabel("Mail :");
